...
class Propietarios extends CI_Controller {
	...
	public function index()
	{
		...
		//PAGINACION
		$data_view['total'] = $this->clientes_model->countPropietarios();
		...
		//OBTENCION DE DATOS
		$data_view['propietarios'] = $this->clientes_model->getPropietarios($inicial,$data_view['filas_pagina']);




		$this->load->view('/cms/admin/header');
		$this->load->view('/cms/admin/propietarios', $data_view);
	...
	public function insertar(){
		...
		$this->load->model('cms/clientes_model');
	   	...
	   	if(!$existe){
   			...
   			redirect('http://www.p4e.hol.es/cms/propietarios','refresh');
   		}else{
	...
	public function actualizar(){
		...
		$existe = false;
		$id_cambiar = $_POST['codPropietario'];
	...
	public function borrar(){
		...
		redirect('http://www.p4e.hol.es/cms/propietarios?p='.$pagina,'refresh');
	}
