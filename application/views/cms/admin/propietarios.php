...
<main class="contenido">
		  		...
		  		<table class="table table-striped table-responsive margin-tabla text-center row letra-fina">
			  		...
			  		<tr>
			  			...
			  			<td class="text-center">
			  				...
			  				<td>
			  				<a href="http://www.p4e.hol.es/cms/propietarios/borrar?id=<?php echo $value['ID']; ?>&p=<?php echo $pagina_actual; ?>"> <button type="button" class="form-control btn btn-danger">
		...
		<div class="modal fade" id="insertar" tabindex="-1" role="dialog" aria-labelledby="insertarLabel" aria-hidden="true">
			<div class="modal-dialog"> <div class="modal-content"> 
					...
					<div class="modal-header">
				        ...
				        <h4 class="modal-title" id="insertarLabel">Insertar Propietario</h4>
				    </div>

				    <div class="modal-body">
				     	
				     	<form class="form-horizontal" action="http://www.p4e.hol.es/cms/propietarios/insertar" method="post">
		...
		<div class="modal fade" id="actualizar" tabindex="-1" role="dialog" aria-labelledby="actualizarLabel" aria-hidden="true">
			<div class="modal-dialog"> <div class="modal-content"> 
					...
					<div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				        <h4 class="modal-title" id="actualizarLabel">Actualizar Propietario</h4>
				    </div>

				    <div class="modal-body">
				     	
				     	<form class="form-horizontal" action="http://www.p4e.hol.es/cms/propietarios/actualizar" method="post">
				     	...
				     	<div class="row">
				     		...
				     		<div class="col-sm-3">
				     			<input type="text" class="form-control text-center" id="codPropietario" name="codPropietario"  readonly>
				     		</div>
				     		<div class="col-sm-3"></div>
				     	</div>
...
<script language="javascript">
	...
	$('#actualizar').on('show.bs.modal', function(e) { 
		...
		$(e.currentTarget).find('input[name="codPropietario"]').val(bookId); 
