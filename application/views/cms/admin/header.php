...
<body>
	...
	<nav class="navbar-inverse navbar-default negro navbar-fixed-top">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="http://www.p4e.hol.es/">CMS</a>
		    </div>
		    ...
		    <ul class="nav navbar-nav">
		        ...
		        <li id="panel" class="<?php if(strcmp ($_SERVER['REQUEST_URI'],'/cms/profile') == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/profile">Panel de Gestion</a></li>
		        <li id="estudiantes" class="<?php if(strncmp ($_SERVER['REQUEST_URI'],'/cms/estudiantes',14) == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/estudiantes">Estudiantes</a></li>
		        <li id="propietarios" class="<?php if(strncmp ($_SERVER['REQUEST_URI'],'/cms/propietarios',15) == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/propietarios">Propietarios</a></li>
		        ...
		        <li id="localidades" class="<?php if(strncmp ($_SERVER['REQUEST_URI'],'/cms/localidades',14) == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/localidades">Localidades</a></li>
