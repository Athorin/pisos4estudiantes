		  		...
		  		<table class="table table-striped table-responsive margin-tabla text-center row letra-fina">
			  		...
			  		<tr>
			  			...
			  			<td class="text-center">
			  				...
			  				<td>
			  				<a href="http://www.p4e.hol.es/cms/viviendas/borrar?id=<?php echo $value['ID']; ?>&p=<?php echo $pagina_actual; ?>"> <button type="button" class="form-control btn btn-danger">
			  		...
			  		<?php endforeach; ?>
			  			<tr><td><td colspan="4"></td><td><div class="text-center">Total <span class="btn btn-success"><?php echo $total; ?></span></div></td></tr>
			  	</table>
