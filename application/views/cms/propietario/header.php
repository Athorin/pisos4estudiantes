		  ...
		  <div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav">
		        ...
		        <li id="panel" class="<?php if(strcmp ($_SERVER['REQUEST_URI'],'/cms/profile') == 0 ){echo 'active';}?>">
		      	...
		      	<li id="viviendas" class="<?php if(strncmp ($_SERVER['REQUEST_URI'],'/cms/propiedades',14) == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/propiedades">Propiedades</a></li>
		        <li id="alquiler" class="<?php if(strncmp ($_SERVER['REQUEST_URI'],'/cms/alquiler',11) == 0 ){echo 'active';}?>">
		        	<a href="http://www.p4e.hol.es/cms/alquiler">Alquiler</a></li>		         
		    </ul>
